...
class CNN(nn.Module):
    def __init__(self,act):
        ...
        #在图片外围补一圈（保持28*28不变），用六种3*3的卷积核扫描得到六种28*28的特征表示
        self.pool1=nn.MaxPool2d(2,2)#降采样28*28->14*14
        self.conv2=nn.Conv2d(6,16,3,padding=1)
        #图片还是14*14，6种特征组合成了16种特征
        self.pool2=nn.MaxPool2d(2,2)#降采样14*14->7*7
        self.conv3=nn.Conv2d(16,128,3,padding=1)
        #图片还是7*7,16种特征组成了128种特征
        self.pool3=nn.MaxPool2d(2,2)#降采样7*7->3*3
...
def print_loss():
    ...
    plt.savefig('loss_new.png',dpi=300)
    plt.show()
...
def print_acc():
    ...
    plt.savefig('acc_new.png',dpi=300)
    plt.show()
