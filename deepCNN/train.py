...
from model_plain import SimpleCNN
from model_dropout import DropoutResNet
...
def paint_loss():
    ...
    plt.plot(epoch_list,loss_Simple100,color='red',marker='o',label='SimpleResNet')
    plt.plot(epoch_list,loss_CNN100,color='blue',marker='s',label='SimpleCNN')
    plt.plot(epoch_list,loss_Dropout100,color='green',marker='^',label='DropoutResNet')
